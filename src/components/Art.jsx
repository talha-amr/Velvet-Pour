            ...
            <div className='container-content'>
                <div className="flex flex-col justify-between items-center w-full">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 translate-y-[30%] w-full px-6">
                        <div className="max-w-7xl mx-auto flex justify-between items-start gap-12 will-fade">
                ...
                <div className=" absolute  bottom-0 inset-x-0  text-center">
                    <div className="font-modern-negra will-fade text-3xl md:text-5xl">
                        Sip-Worthy Perfection
                    </div>
                    <h2 className="text-3xl md:text-5xl will-show font-modern-negra opacity-0">
